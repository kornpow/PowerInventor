...
class Scheduler:
	...
	def add_to_table(self,hour,minute,outlet,onoff):
		conn = sqlite3.connect(os.getcwd() + 'GrowerApp.db')
		print "Adding value to tasklist"
		c = conn.cursor()
		pack = (hour,minute,outlet,onoff)
...
if(sys.argv[1] == "check"): 
	schedule.check_event(growerapp)
